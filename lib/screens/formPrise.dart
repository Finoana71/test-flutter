...
class FormPrisePage extends StatefulWidget {
  @override
  _FormPrisePageState createState() => _FormPrisePageState();

  Dossier dossier;

  FormPrisePage({required this.dossier});
}

class _FormPrisePageState extends State<FormPrisePage> {
  ...
  static Statut statut = Statut.Pris;
